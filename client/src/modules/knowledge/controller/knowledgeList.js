...
var knowledgeList = ['$scope', 'KnowledgeDc', 'KnowledgeType', '$stateParams', '$mdDialog', 'Sprite',
  function($scope, KnowledgeDc, KnowledgeType, $stateParams, $mdDialog, Sprite){
    /**
     * 定义对象
     */
    ...
    $scope.showUpdate = function(id){
      ...
      $mdDialog.show({
        ...
        templateUrl: 'knowledgeUpdateTpl',
