...
var knowledgeUpdate = ['$scope', 'KnowledgeType', 'KnowledgeDc', 'FileUploader', 'Constant', 'Sprite', '$mdDialog',
  function($scope, KnowledgeType, KnowledgeDc, FileUploader, Constant, Sprite, $mdDialog){
    /**
     * 对象声明
     */
...
module.exports = knowledgeUpdate;